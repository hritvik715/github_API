...
async function fetchData(username) {
  try {
    ...
    //imp-> hamne upper vaala html code section tag kay andar daal diya
...
async function fetchRepos(username) {
  try {
    ...
    //imp-> isse console mey dala print kro 
    console.log(data);
    ...
    data.forEach(
      ({
        ...
        //imp-> replace kiya taaki repository launch ho jaae , replace nhi kroge toh repository launch nhi hogi
